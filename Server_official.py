...
# Tải mô hình dịch sang tiếng Việt
...
# Biến lưu trạng thái hiện tại của mô hình (0: BLIP, 1: VietOCR)
current_model = mp.Value('i', 0)

# Hàm sinh mô tả từ hình ảnh bằng BLIP
def generate_caption_blip(frame):
        ...
        while True:
            ...
            if command == '1':
                ...
                if current_model.value == 0:
                    response_text = generate_caption_blip(frame)
